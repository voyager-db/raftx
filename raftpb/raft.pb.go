...
type EntryOrigin int32

const (
	EntryOriginUnknown EntryOrigin = 0
	EntryOriginSelf    EntryOrigin = 1
	EntryOriginLeader  EntryOrigin = 2
)

var EntryOrigin_name = map[int32]string{
	0: "EntryOriginUnknown",
	1: "EntryOriginSelf",
	2: "EntryOriginLeader",
}

var EntryOrigin_value = map[string]int32{
	"EntryOriginUnknown": 0,
	"EntryOriginSelf":    1,
	"EntryOriginLeader":  2,
}

func (x EntryOrigin) Enum() *EntryOrigin {
	p := new(EntryOrigin)
	*p = x
	return p
}

func (x EntryOrigin) String() string {
	return proto.EnumName(EntryOrigin_name, int32(x))
}

func (x *EntryOrigin) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(EntryOrigin_value, data, "EntryOrigin")
	if err != nil {
		return err
	}
	*x = EntryOrigin(value)
...
func (EntryOrigin) EnumDescriptor() ([]byte, []int) {
...
type Entry struct {
	...
	Origin    *EntryOrigin `protobuf:"varint,5,opt,name=origin,enum=raftpb.EntryOrigin" json:"origin,omitempty"`
	ContentId []byte       `protobuf:"bytes,6,opt,name=content_id,json=contentId" json:"content_id,omitempty"`
	ClientId  []byte       `protobuf:"bytes,7,opt,name=client_id,json=clientId" json:"client_id,omitempty"`
...
// Lightweight ref used in fast votes & election seeding
type EntryRef struct {
	Index     *uint64      `protobuf:"varint,1,opt,name=index" json:"index,omitempty"`
	Term      *uint64      `protobuf:"varint,2,opt,name=term" json:"term,omitempty"`
	ContentId []byte       `protobuf:"bytes,3,opt,name=content_id,json=contentId" json:"content_id,omitempty"`
	Origin    *EntryOrigin `protobuf:"varint,4,opt,name=origin,enum=raftpb.EntryOrigin" json:"origin,omitempty"`
}

func (m *EntryRef) Reset()         { *m = EntryRef{} }
func (m *EntryRef) String() string { return proto.CompactTextString(m) }
func (*EntryRef) ProtoMessage()    {}
func (*EntryRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_b042552c306ae59b, []int{1}
}
func (m *EntryRef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EntryRef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EntryRef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EntryRef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EntryRef.Merge(m, src)
}
func (m *EntryRef) XXX_Size() int {
	return m.Size()
}
func (m *EntryRef) XXX_DiscardUnknown() {
	xxx_messageInfo_EntryRef.DiscardUnknown(m)
}

var xxx_messageInfo_EntryRef proto.InternalMessageInfo
...
type Message struct {
	...
	CandLastLeaderIndex *uint64   `protobuf:"varint,15,opt,name=cand_last_leader_index,json=candLastLeaderIndex" json:"cand_last_leader_index,omitempty"`
	CandLastLeaderTerm  *uint64   `protobuf:"varint,16,opt,name=cand_last_leader_term,json=candLastLeaderTerm" json:"cand_last_leader_term,omitempty"`
	// For MsgPreVoteResp / MsgVoteResp: seed new leader (§6.3)
	SelfApproved []*EntryRef `protobuf:"bytes,17,rep,name=self_approved,json=selfApproved" json:"self_approved,omitempty"`
	// For MsgFastVote (votes from followers to leader, §5): per-index votes
	FastVotes   []*EntryRef `protobuf:"bytes,18,rep,name=fast_votes,json=fastVotes" json:"fast_votes,omitempty"`
	LocalCommit *uint64     `protobuf:"varint,19,opt,name=local_commit,json=localCommit" json:"local_commit,omitempty"`
}
...
func init() {
	proto.RegisterEnum("raftpb.EntryOrigin", EntryOrigin_name, EntryOrigin_value)
	...
	proto.RegisterType((*EntryRef)(nil), "raftpb.EntryRef")
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RequestId != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.RequestId))
		i--
		dAtA[i] = 0x40
	}
	if m.ClientId != nil {
		...
		i = encodeVarintRaft(dAtA, i, uint64(len(m.ClientId)))
		i--
		dAtA[i] = 0x3a
	}
	if m.ContentId != nil {
		...
		i = encodeVarintRaft(dAtA, i, uint64(len(m.ContentId)))
		i--
		dAtA[i] = 0x32
	}
	if m.Origin != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.Origin))
		i--
		dAtA[i] = 0x28
	}
	if m.Data != nil {
...
func (m *EntryRef) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EntryRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EntryRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.LocalCommit != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.LocalCommit))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	...
	if len(m.SelfApproved) > 0 {
		for iNdEx := len(m.SelfApproved) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SelfApproved[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.CandLastLeaderTerm != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.CandLastLeaderTerm))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	}
	if m.CandLastLeaderIndex != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.CandLastLeaderIndex))
		i--
		dAtA[i] = 0x78
	}
...
func (m *Entry) Size() (n int) {
	...
	if m.RequestId != nil {
		n += 1 + sovRaft(uint64(*m.RequestId))
	}
	return n
}

func (m *EntryRef) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message) Size() (n int) {
	...
	if m.CandLastLeaderIndex != nil {
		n += 1 + sovRaft(uint64(*m.CandLastLeaderIndex))
	}
	if m.CandLastLeaderTerm != nil {
		n += 2 + sovRaft(uint64(*m.CandLastLeaderTerm))
	}
	if len(m.SelfApproved) > 0 {
		for _, e := range m.SelfApproved {
			l = e.Size()
	...
	if m.LocalCommit != nil {
		n += 2 + sovRaft(uint64(*m.LocalCommit))
	}
	return n
}
...
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ContentId = append(m.ContentId[:0], dAtA[iNdEx:postIndex]...)
			if m.ContentId == nil {
				m.ContentId = []byte{}
			}
			iNdEx = postIndex
...
func (m *EntryRef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EntryRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EntryRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CandLastLeaderIndex", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CandLastLeaderIndex = &v
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CandLastLeaderTerm", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CandLastLeaderTerm = &v
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelfApproved", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SelfApproved = append(m.SelfApproved, &EntryRef{})
			if err := m.SelfApproved[len(m.SelfApproved)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 18:
			...
			m.FastVotes = append(m.FastVotes, &EntryRef{})
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalCommit", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
